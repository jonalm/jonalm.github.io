...
- Developed ML model to predict ship hull fouling based on noon report data, which outperformed numerically costly CFD based models, for clients in the maritime sector.
...
- Developed simulations and theoretical models for multiphase flow phenomena. 
- Characterized complex patterning behavior involving granular materials.
...
- Thesis: Pattern Formation in Granular Fluids. 
...
- Thesis: Overlap Distributions of Random Cantor Sets and their Applications.
...
- Computer skills
	...
	- Working knowledge in Linux/UNIX, C/C++, git, Jira etc.
- Voluntary work
